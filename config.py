...
# time_3 - итоговое время, которое будет записано в таблицу
...
# book_saved - флаг, который поднимается, если документ получилось сохранить. Нужен, чтобы сохранять файл ещё раз, когда он был открыт.
# missundestand - если сообщение не подошло ни под один из шаблонов, сообщаем об этом сотруднику
#
